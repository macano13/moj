...
<section class="content">
  ...
  <div class="card-body " style="border: border: 3px solid red;">
    <h4 class="card-title">Multi subtitle translator implementation</h4>
    <p class="card-text">In the near future we will implement a Multi subtitle translator where users will be able to upload multiple subtitles at once and where they will be able to translate 10 to 15 subtitles at once.</p>
