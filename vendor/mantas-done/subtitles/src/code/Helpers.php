...
include_once 'Converters/ConverterContract.php';
include_once 'Converters/AssConverter.php';
include_once 'Converters/DfxpConverter.php';
include_once 'Converters/SbvConverter.php';
include_once 'Converters/SrtConverter.php';
include_once 'Converters/StlConverter.php';
include_once 'Converters/SubConverter.php';
include_once 'Converters/TtmlConverter.php';
include_once 'Converters/TxtConverter.php';
include_once 'Converters/VttConverter.php';
class Helpers
{
